...
# impor libraries very important
...
# import Tensorflow (with implement Keras) engine
...
# call Model for Build best img and use loss and gradients, process major work from computing 
